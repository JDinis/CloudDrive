...
class AddUsers extends Component {
	...
	saveUser(e) {
		...
		this.props.addUser(username, password, email, firstName, lastName, profilePic, admin, () => {
			this.props.getUser();
...
export default withRouter(connect(mapStateToProps, { addUser, isLogged, getUser })(AddUsers));