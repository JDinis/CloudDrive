			...
			return (
				<div style={{ flex: '1 1 auto', flexFlow: 'column', minHeight: "70vh", marginTop: "2vh" }}>
					<center>
						...
						<NavLink exact to="/profile/edit" className="btn btn-success">Edit</NavLink>
...
export default withRouter(connect(mapStateToProps, { getUser, deleteUser, isLogged })(UserPage));